        ...
        <div class="main">
          <form style="padding-top: 5%; padding-left: 5%">
            <div class="form-group row">
              <label for="inputDestinasi" class="col-sm-3 col-form-label">Nama Destinasi</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputDestinasi" placeholder="Destinasi" />
              </div>
            </div>
            ...
            <div class="form-group row" style="padding-top: 3%">
              ...
              <div class="form-group col-sm-9">
                <select class="custom-select my-1 mr-sm-9" id="inlineFormCustomSelectPref">
            ...
            <div class="form-group row" style="padding-top: 3%">
              <label for="inputHarga" class="col-sm-3 col-form-label">Rentan harga</label>
              <div class="col-sm-9">
                <div class="d-flex">
                  <div class="input-group">
                    <span class="input-group-text">Rp.</span>
                    <input type="text" class="form-control m-0" aria-label="Amount (to the nearest dollar)">
                  </div>
